...
module.exports = (robot) => {
  ...
  const jokes = ["Lots of people believe that french fries we're first cooked in France. In fact, it was Greece.", "What's a computer's favorite beat? Al algo-rhythm.", "I dropped my laptop off my uncle's boat the other day, not there's aDell Rolling in the Deep", "What gender is the chocolate bar? Her/She", "The inventer of Velcro died. RIP", "Elton John hates Spinach...He's a RocketMan"]
